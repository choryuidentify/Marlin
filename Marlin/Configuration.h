...
#define STRING_CONFIG_H_AUTHOR "(Choryu Park, Based on NiXXiN's work)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Choryu Adv. AM8"
...
#define PIDTEMPBED
  ...
  // Anet A8 Original Heat Bed + 2mm Epoxy Bed + Ender Lightweight Chamber
  #define DEFAULT_BED_KP 205.65
  #define DEFAULT_BED_KI 37.60
  #define DEFAULT_BED_KD 749.93
...
// #define DEFAULT_MAX_ACCELERATION      { 1800, 1600, 100, 10000 }
...
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves  #define JUNCTION_DEVIATION_MM 0.10  // (mm) Distance from real junction edge
